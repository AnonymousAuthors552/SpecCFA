...
def build_test_files(subpaths, app, size):
    ...
    with open("omsp_system.h", "w") as sys_file:
    ...
    with open("validate.py", "w") as val_file:
    ...
    with open("wrapper.c", "w") as wrap_file:
...
def build_blockmem(paths):
    ...
    with open("blockmem.v", "w") as block_file:
...
def build_fpga(paths):
    ...
    with open("openMSP430_fpga.v", "w") as fpga_file:
...
def build_meta(subpaths, paths):
    ...
    with open("speccfa_metadata.v", "w") as meta_file:
...
def build_msp(paths):
    ...
    with open("openMSP430.v", "w") as msp_file:
...
def build_spec(paths):
    ...
    with open("speccfa.v", "w") as spec_file:
...
def build_boundry_monitor(hex):
    ...
    with open("boundary_monitor.v", "w") as boundary_file:
...
def build_cflogmem(hex, bits):
    ...
    with open("cflogmem.v", "w") as cflogmem_file:
...
def build_cflow(hex):
    ...
    with open("cflow.v", "w") as cflow_file:
